...
> **Core question:** when a small adapter changes a frozen model, what evidence tells you whether it learned the intended mechanism rather than a cheap side effect?
...
DIFFICULTY = 4
IMPORTANCE = 4
EXPECTED_RUNTIME = "75-105 minutes; learner signature and final verification require CUDA"
REQUIRES_GPU = True
```
