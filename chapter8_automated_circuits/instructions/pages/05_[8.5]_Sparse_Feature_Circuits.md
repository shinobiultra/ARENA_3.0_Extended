...
EXPECTED_RUNTIME = "seconds on CPU for the learner theorem; CUDA/external artifacts verified separately"
...
**Core question:** can we discover a causal graph over interpretable SAE features, rather than over opaque residual dimensions, and know when the graph is faithful enough to trust?
