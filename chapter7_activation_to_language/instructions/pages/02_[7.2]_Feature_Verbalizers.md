...
def run_gpu_test(max_vram_gb: float = 24.0) -> dict:
    from part2_feature_verbalizers import solutions as reference

    return reference.run_transformerlens_feature_verbalizer_signature_result(max_vram_gb=max_vram_gb)
