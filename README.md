...
prototype implementation surface plus nineteen polished ARENA-style sections:
...
and [8.4 Circuit Tracing with Attribution Graphs](chapter8_automated_circuits/instructions/pages/04_%5B8.4%5D_Circuit_Tracing_with_Attribution_Graphs.md).
