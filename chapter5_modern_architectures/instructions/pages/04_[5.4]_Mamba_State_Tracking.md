...
> recurrent SSM cache carry the exact latent depth, and does editing that cache change its
> future predictions?
...
requires_gpu: false
task: exact bounded bracket-depth tracking
model: one-layer TinyMambaModel from section 5.3
train_length: 16
ood_length: 32
```
